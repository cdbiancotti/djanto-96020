...
Para editar o borrar pages debes estar logueado. <---------------> ###Piezas sugeridas
...
Es muy importante
PROBAR, PROBAR Y PROBAR ANTES DE SUBIR EL CÓDIGO A GITHUB... (no apurarse a hacer el commit y subir los cambios porque puede generar algún problema sin darnos cuenta). --- <--------------->
...
Messenger y like - integración otra db <---------------> ###Dont’s
